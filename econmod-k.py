...
def report(distribution=gauss, transaction_fn=more_to_the_poor, interaction_fn=anyone,N=N, mu=mu, T=5*N,
...
##
    ...
    plt.show()
def main():
    report(custom,split_neutral_growth,record_every=1,N=1000,T=10000)
